...
//       planetLsDict[pl]["LsRow"] = row;
//       /*
//       lsinfo = getLsPlanetTime(datenow_int, pl, true);
//       lsval = lsinfo[0];
//       planetLsDict[pl] = {'Ls':lsval, 'dLs':lsinfo[1], 't0':datenow_int, 'LdNowRow':row};
...
// Function to create the date/Ls table for a given planet
...
function initPage() {
    ...
    // The rest of this function handles the individual planet date/Ls data tables
